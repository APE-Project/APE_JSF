/**
 * SSE Transport object
 *
 * @name APE.Transport.JSONP
 * @augments APE.Transport.SSE.prototype
 * @class
 * @private
 */
...
/**
 * Check if the browser supports JSONP
 *
 * @name APE.Transport.JSONP.browserSupport
 * @returns {boolean}
 * @function
 * @private
 */
