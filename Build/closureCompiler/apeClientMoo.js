...
'/?[{"cmd":"script","params":{"domain":"'+document.domain+'","scripts":["'+a.scripts.join('","')+'"]}}]');c.contentWindow.location.href=c.get("src")}c.addEvent("load",function(){c.contentWindow.APE?c.contentWindow.APE.init(a):setTimeout(c.onload,100)})}});
