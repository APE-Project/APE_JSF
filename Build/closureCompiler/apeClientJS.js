...
this.cookie.read("APE_Cookie"),d=eval("("+c+")");if(d)b.frequency=d.frequency+1;else c='{"frequency":0}';d=new RegExp('"frequency":([ 0-9]+)',"g");c=c.replace(d,'"frequency":'+b.frequency);this.cookie.write("APE_Cookie",c);var e=document.createElement("iframe");e.setAttribute("id","ape_"+b.identifier);e.style.display="none";e.style.position="absolute";e.style.left="-300px";e.style.top="-300px";document.body.insertBefore(e,document.body.childNodes[0]);e.onload=function(){e.contentWindow.APE?e.contentWindow.APE.init(b):
setTimeout(e.onload,100)};if(b.transport==2){c=e.contentDocument;if(!c)c=e.contentWindow.document;c.open();d="<html><head>";for(var f=0;f<b.scripts.length;f++)d+='<script type="text/JavaScript" src="'+b.scripts[f]+'"><\/script>';d+="</head><body></body></html>";c.write(d);c.close()}else{e.setAttribute("src",(b.secure?"https":"http")+"://"+b.frequency+"."+b.server+'/?[{"cmd":"script","params":{"domain":"'+document.domain+'","scripts":["'+b.scripts.join('","')+'"]}}]');if(navigator.product=="Gecko")e.contentWindow.location.href=
e.getAttribute("src")}};if(Function.prototype.bind==null)Function.prototype.bind=function(b,c){return this.create({bind:b,arguments:c})};if(Function.prototype.create==null)Function.prototype.create=function(b){var c=this;b=b||{};return function(){var d=b.arguments||arguments;if(d&&!d.length)d=[d];function e(){return c.apply(b.bind||null,d)}return e()}};
