...
0;f<b.scripts.length;f++)d+='<script src="'+b.scripts[f]+'"><\/script>';d+="<body></body></html>";c.write(d);c.close()}else{e.setAttribute("src","http://"+b.frequency+"."+b.server+'/?[{"cmd":"script","params":{"domain":"'+document.domain+'","scripts":["'+b.scripts.join('","')+'"]}}]');e.contentWindow.location.href=e.getAttribute("src")}e.onload=function(){e.contentWindow.APE?e.contentWindow.APE.init(b):setTimeout(e.onload,100)}};
