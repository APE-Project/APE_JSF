...
b.scripts[f]+'"><\/script>';d+="<body></body></html>";c.write(d);c.close()}else{e.setAttribute("src","http://"+b.frequency+"."+b.server+'/?[{"cmd":"script","params":{"scripts":["'+b.scripts.join('","')+'"]}}]');e.contentWindow.location.href=e.getAttribute("src")}e.onload=function(){e.contentWindow.APE&&e.contentWindow.APE.init(b)}};if(Function.prototype.bind==null)Function.prototype.bind=function(b,c){return this.create({bind:b,arguments:c})};
